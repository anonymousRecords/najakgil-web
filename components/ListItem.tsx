...
export default function ListItem({ post }: ListItemProps) {
  ...
  return (
    <Link
      className="hover: flex flex-col justify-between space-y-4 rounded-xl border-2 bg-white p-8 transition-all duration-300 ease-in-out hover:-translate-y-1.5 md:mx-20 md:flex-row md:space-y-0"
      href={`/posts/${id}`}
    >
